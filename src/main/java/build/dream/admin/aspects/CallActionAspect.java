package build.dream.admin.aspects;
...
public class CallActionAspect {
    ...
    @Around(value = "execution(public * build.dream.admin.controllers.*.*(..)) && @annotation(apiRestAction)")
    ...
    @Around(value = "execution(public * build.dream.admin.controllers.*.*(..)) && @annotation(modelAndViewAction)")
